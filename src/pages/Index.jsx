      ...
      <VStack spacing={4}>
        <HStack width="full" justifyContent="space-between">
          <Box boxSize="150px" position="relative">
            <Image src="https://images.unsplash.com/photo-1642334640124-c80d5e7e78d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxhbmltYXRlZCUyMGF2YXRhcnxlbnwwfHx8fDE3MTI1NDQxNjV8MA&ixlib=rb-4.0.3&q=80&w=1080" borderRadius="full" />
